        ...
        <div class="content">
        	...
        	<div class="storeInfo">
        		<div class="storeInfoDiv">
        			...
        			<div>
        				<div><span class="snum">00000001</span></div>
        				<div><span>키워드1</span></div>
        				<div><span>김밥천국</span></div>
        				<div><span>별점(리뷰개수)1</span></div>
        				<div><span>거리, 동이름1</span></div>
        				<div><span>예약 종류1</span></div>
        			</div>
        		</div>
        		<div class="storeInfoDiv">
        			<div>
        			...
        			<div>
        				<div><span class="snum">00000002</span></div>
        				<div><span>키워드2</span></div>
        				<div><span>엽기떡볶이</span></div>
        				<div><span>별점(리뷰개수)2</span></div>
        				<div><span>거리, 동이름2</span></div>
        				<div><span>예약 종류2</span></div>
        			</div>
        		</div>
        		<div class="storeInfoDiv">
        			<div>
        			...
        			<div>
        				<div><span class="snum">00000003</span></div>
        				<div><span>키워드3</span></div>
        				<div><span>버거킹</span></div>
        				<div><span>별점(리뷰개수)3</span></div>
        				<div><span>거리, 동이름3</span></div>
        				<div><span>예약 종류3</span></div>
        			</div>
        		</div>
        		<div class="storeInfoDiv">
        			<div>
        			...
        			<div>
        				<div><span class="snum">00000004</span></div>
        				<div><span>키워드4</span></div>
        				<div><span>연돈</span></div>
        				<div><span>별점(리뷰개수)4</span></div>
        				<div><span>거리, 동이름4</span></div>
        				<div><span>예약 종류4</span></div>
        			</div>
        		</div>
        		<div class="storeInfoDiv">
        			<div>
        			...
        			<div>
        				<div><span class="snum">00000005</span></div>
        				<div><span>키워드5</span></div>
        				<div><span>온센</span></div>
        				<div><span>별점(리뷰개수)5</span></div>
        				<div><span>거리, 동이름5</span></div>
        				<div><span>예약 종류5</span></div>
        			</div>
        		</div>
        	</div>
        </div>
