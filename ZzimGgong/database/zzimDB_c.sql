...
--    varchar2(30) constraint restaurant_resNum_pk primary key,
...
--INSERT INTO RESTAURANT VALUES('resNum001')
--
...
--   connect_auth varchar2(20),
--   restaurant_code varchar2(20),
--   no_show number
--);
--
----포장 테이블
...
--);
--
--SELECT * FROM RESTAURANT WHERE resnum='resNum001';
--
create table restaurant(--가게 테이블
